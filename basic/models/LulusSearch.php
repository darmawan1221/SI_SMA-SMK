...
/**
 * LulusSearch represents the model behind the search form of `app\models\Lulus`.
 */
class LulusSearch extends Lulus
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Lulus::find()->joinWith('daerah')->joinWith('tahun')->joinWith('jenises');
