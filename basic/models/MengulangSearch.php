...
/**
 * MengulangSearch represents the model behind the search form of `app\models\Mengulang`.
 */
class MengulangSearch extends Mengulang
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Mengulang::find()->joinWith('daerah')->joinWith('tahun')->joinWith('jenises');
