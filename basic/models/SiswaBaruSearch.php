...
/**
 * SiswaBaruSearch represents the model behind the search form of `app\models\SiswaBaru`.
 */
class SiswaBaruSearch extends SiswaBaru
{
    ...
    {
        $query = SiswaBaru::find()->joinWith('daerah')->joinWith('tahun')->joinWith('jenises');
